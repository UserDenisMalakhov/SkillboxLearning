...
//interface
public abstract class LightingDevice3 implements ElectricDevice, Comparable{
    ...
    public LightingDevice3(int power){
        this.power = power;
    }
    ...
    public int compareTo(Object o) {
        LightingDevice3 lightingDevice = (LightingDevice3) o;
