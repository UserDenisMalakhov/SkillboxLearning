...
//interface
public abstract class LightingDevice5 implements ElectricDevice, Comparable{
    ...
    public LightingDevice5(int power){
        this.power = power;
    }
    ...
    public int compareTo(Object o) {
        LightingDevice5 lightingDevice = (LightingDevice5) o;
