public class Main {
    public static void main(String[] args) {
        int paperReserve = 6000;
        int inkReserve = 600000;
        int coverReserve = 2000;
        double printRollerMinTemp = 80.5; double printRollerMaxTemp = 120.75;
        int pagesInBook = 530;
        int booksCount = 2000;
        ...
        boolean paperIsEnough = papersCount <=
                paperReserve;
        boolean inkIsEnough = inkedPapersCount <=
                inkReserve;
        boolean coversAreEnough = booksCount <=
                coverReserve;
        ...
        if (!coversAreEnough) {
            errors = true;
            System.out.println("Обложен недостаточно");
        }
